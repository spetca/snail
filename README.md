...
**S**pectral **N**avigation **A**nd **I**Q **L**ab - although i totally made the name "snail" first and then figured out a not-so-clever acronymn for it. Also something something about how snails leave trails and so do rf signals or something like that. 
